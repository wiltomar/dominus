...
CREATE TABLE IF NOT EXISTS public.countrycurrency (
	id uuid DEFAULT uuid_generate_v4(),
	countryid uuid NOT NULL,
...
CREATE TABLE IF NOT EXISTS administrative.person (
    id uuid DEFAULT uuid_generate_V4(),
    name VARCHAR(80) NOT NULL,
    countryid uuid NOT NULL,
    typeofperson SMALLINT,
	status BOOLEAN DEFAULT TRUE,
	createdat TIMESTAMP WITH TIME ZONE DEFAULT statement_timestamp(),
	updatedat TIMESTAMP WITH TIME ZONE,
	deletedat TIMESTAMP WITH TIME ZONE,
	CONSTRAINT person_pkey PRIMARY KEY (id),
	CONSTRAINT pesron_check_typeofperson CHECK (typeofperson BETWEEN 1 AND 3),
	CONSTRAINT person_fkey_countryid FOREIGN KEY (countryid) REFERENCES public.country (id) ON UPDATE CASCADE ON DELETE RESTRICT
);
